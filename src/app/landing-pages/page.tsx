...
<div className="csp">
  <div className="csp-hero has-fig rvsec">
    ...
    <ul className="csp-ticks rv">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Built to convert, not just look good</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Mobile-first, sub-second load</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>A/B tested until they climb</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Message-matched to each campaign</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Deal direct, no managers</li>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> The problem</span>
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">Your ads are working. <span className="dim">Your page isn’t.</span></h2></div>
    </div>
    <div className="cf-prob rv">
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2" strokeLinecap="round" strokeLinejoin="round"/></svg></span><h4>Slow load times</h4><p>Every extra second of load time quietly kills conversions — and you’re still paying for the click.</p></div>
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 5h16M4 12h10M4 19h7" strokeLinecap="round"/></svg></span><h4>Generic messaging</h4><p>Sending high-intent traffic to a homepage or a one-size-fits-all page means the message never matches the search.</p></div>
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 3v18M3 12h18" strokeLinecap="round"/></svg></span><h4>No testing</h4><p>Without structured A/B testing you’re guessing — and leaving conversion rate (and revenue) on the table.</p></div>
    </div>
  </div>
</section>
...
<section className="sec sec-cream sec-w rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> What we build</span>
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">Pages engineered <span className="dim">to convert.</span></h2></div>
    </div>
    <div className="cf-feat rv">
      <article className="cf-fc"><h4>Message-matched</h4><p>Every page mapped to its campaign and keyword, so the message matches the moment your customer searched.</p>
        <div className="pm"><div className="pm-hd">Campaign → page <span className="pm-chip">MATCHED</span></div>
          <div className="pm-row"><span className="pm-l"><b>Search term</b><span>“emergency plumber”</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
          <div className="pm-row"><span className="pm-l"><b>Headline</b><span>Matches intent</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
          <div className="pm-row"><span className="pm-l"><b>Offer</b><span>Above the fold</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
        </div>
      </article>
      <article className="cf-fc"><h4>Fast &amp; mobile-first</h4><p>Built to load in under a second on mobile, where most of your paid traffic actually converts.</p>
        <div className="pm"><div className="pm-hd">Performance <span className="pm-chip">PASSING</span></div>
          <div className="pm-row"><span className="pm-l"><b>Largest paint</b><span>Mobile</span></span><span className="pm-val up">0.9s</span></div>
          <div className="pm-row"><span className="pm-l"><b>PageSpeed</b><span>Mobile score</span></span><span className="pm-val up">98</span></div>
          <div className="pm-row"><span className="pm-l"><b>Core Web Vitals</b><span>All metrics</span></span><span className="pm-tag">Green</span></div>
        </div>
      </article>
      <article className="cf-fc"><h4>Relentlessly tested</h4><p>Headlines, offers and layouts A/B tested continuously, so conversion rate only ever goes one way — up.</p>
        <div className="pm"><div className="pm-hd">Landing page <span className="pm-chip">A/B TEST</span></div>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> Built to convert</span>
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">The conversion elements <span className="dim">we build in.</span></h2></div>
    </div>
    <div className="grt-grid rv" style={{'gridTemplateColumns':'repeat(3,1fr)'}}>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 5h16M4 12h10M4 19h7" strokeLinecap="round"/></svg></span>
        <h3>Message match</h3>
        <p>The headline mirrors the exact search that drove the click, so intent and offer line up in the first two seconds.</p>
      </div>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 3l2.5 5 5.5.8-4 3.9.9 5.5L12 16.5 7.1 18.2 8 12.7 4 8.8 9.5 8z" strokeLinejoin="round"/></svg></span>
        <h3>Trust &amp; social proof</h3>
        <p>Reviews, ratings, guarantees and payment badges placed where hesitation happens — so buyers feel safe clicking buy.</p>
      </div>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2" strokeLinecap="round" strokeLinejoin="round"/></svg></span>
        <h3>Urgency &amp; scarcity</h3>
        <p>Honest stock counts, shipping cut-offs and limited offers that give a real reason to act now instead of later.</p>
      </div>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="5" y="3" width="14" height="18" rx="2"/><path d="M9 7h6M9 11h6M9 15h3" strokeLinecap="round"/></svg></span>
        <h3>Shopify conversion elements</h3>
        <p>Sticky add-to-cart, express &amp; one-tap checkout, and product templates wired to lift add-to-cart and reduce drop-off.</p>
      </div>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M13 2 4 14h6l-1 8 9-12h-6z" strokeLinejoin="round"/></svg></span>
        <h3>Sub-second speed</h3>
        <p>Built to load in under a second on mobile — where most paid traffic lands, and where every slow second bleeds conversions.</p>
      </div>
      <div className="grt-card">
        <span className="grt-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 3v18M3 12h18" strokeLinecap="round"/></svg></span>
        <h3>Frictionless forms</h3>
        <p>Only the fields you actually need, with autofill and clear single CTAs — so more clicks turn into enquiries and sales.</p>
      </div>
    </div>
  </div>
</section>
...
<section className="sec sec-cream sec-w rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> Who we build for</span>
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">Pages that convert, <span className="dim">whatever you sell.</span></h2></div>
    </div>
    <div className="cf-verts rv">
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M6 6h15l-1.5 9h-12z" strokeLinejoin="round"/><circle cx="9" cy="20" r="1.4"/><circle cx="18" cy="20" r="1.4"/></svg><span>E-commerce &amp; Retail</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M6 3h12l3 6-9 12L3 9z" strokeLinejoin="round"/></svg><span>Fashion &amp; Jewellery</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4"/><path d="M5 21c0-4 3-6 7-6s7 2 7 6" strokeLinecap="round"/></svg><span>Health &amp; Beauty</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M14.5 5.5a3.5 3.5 0 0 0-4.9 4.9L4 16v4h4l5.6-5.6a3.5 3.5 0 0 0 4.9-4.9L16 12l-2-2 2.5-4.5z" strokeLinejoin="round"/></svg><span>Trades &amp; Home Services</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 8h8M8 12h8M8 16h5" strokeLinecap="round"/></svg><span>Professional Services</span></span>
      ...
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 11l8-6 8 6" strokeLinejoin="round"/><path d="M6 10v9h12v-9" strokeLinejoin="round"/><path d="M10 19v-4h4v4" strokeLinejoin="round"/></svg><span>Hospitality &amp; Food</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 17l6-6 4 4 6-7" strokeLinecap="round" strokeLinejoin="round"/></svg><span>Fitness &amp; Wellness</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 3l2 5 5 .5-4 3.5 1.5 5L12 14l-4.5 3 1.5-5-4-3.5 5-.5z" strokeLinejoin="round"/></svg><span>Automotive</span></span>
      ...
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 8l-4 4 4 4M15 8l4 4-4 4" strokeLinecap="round" strokeLinejoin="round"/></svg><span>SaaS &amp; Tech</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 4 3 8l9 4 9-4z" strokeLinejoin="round"/><path d="M7 10v5c0 1 2.5 2 5 2s5-1 5-2v-5" strokeLinejoin="round"/></svg><span>Education</span></span>
    </div>
  </div>
</section>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      ...
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">A page rebuild, <span className="dim">by the numbers.</span></h2></div>
    </div>
    <div className="cf-case rv">
      ...
      <div className="cf-case-body">
        <span className="cf-case-tag">Landing page rebuild · E-commerce</span>
        <h3>From a generic homepage to a page built to sell.</h3>
        <p>We replaced a slow, one-size-fits-all homepage with campaign-matched landing pages, rebuilt for speed and A/B tested from day one — lifting conversion rate without spending a dollar more on ads.</p>
        <div className="cf-case-stats">
          <div className="cf-case-stat"><b>+84%</b><span>conversion rate</span></div>
          <div className="cf-case-stat"><b>0.9s</b><span>mobile load time</span></div>
          <div className="cf-case-stat"><b>−28%</b><span>cost per conversion</span></div>
        </div>
      </div>
    </div>
  </div>
...
{/* CTA */}
<section className="sec sec-cream sec-w cta rvsec" id="book">
