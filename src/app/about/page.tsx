...
<section className="sec sec-cream sec-stats rvsec">
  <div className="ctr">
    <div className="stats">
      ...
      <div className="stat rv"><span className="stat-val"><span className="cnt" data-target="4.08" data-decimals="2">4.08</span></span><span className="stat-label">Average ROAS across<br />managed accounts</span></div>
    </div>
  </div>
</section>
...
<section className="sec sec-cream sec-w rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> Our story</span>
      <div className="shead-main">
        <span className="shead-brand rv">Adalytical®</span>
        <h2 className="shead-t rv">Built on the inside. <span className="dim">Run for your bottom line.</span></h2>
      </div>
    </div>
    <div className="prose rv">
      <p><strong>Most agencies learn Google Ads from the outside.</strong> We learned it from the inside — spending years within Google’s own Ads team, seeing exactly how the platform, the algorithms and the internal systems really work.</p>
      <p>What we saw over and over was the same thing: generalist agencies leaving millions of dollars on the table for their clients — mismanaged budgets, broken tracking, set-and-forget campaigns. We started Adalytical to fix that, for good.</p>
      <p>Since then we’ve audited and optimised <strong>1,000+ accounts</strong>, trained <strong>30+ other top agencies</strong>, and become one of the fastest-growing Google Ads agencies in the world — not by doing more channels, but by doing one channel better than anyone else.</p>
      <h3>What we believe</h3>
      <p>Profit beats vanity. A report full of clicks and impressions means nothing if it isn’t making you money. We measure ourselves on ROAS, cost per acquisition and real revenue — the numbers that actually matter.</p>
      <p><strong>And we back it with alignment.</strong> No lock-in contracts. Month-to-month, always. You stay because the numbers keep climbing — never because you’re stuck.</p>
    </div>
  </div>
</section>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> How we operate</span>
      <div className="shead-main">
        <span className="shead-brand rv">Adalytical®</span>
        <h2 className="shead-t rv">The standards <span className="dim">we hold ourselves to.</span></h2>
      </div>
    </div>
    <div className="cf-ind rv">
      <article className="cf-ic">
        <span className="cf-ic-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 3v18h18" strokeLinecap="round"/><path d="M7 14l4-4 3 3 5-6" strokeLinecap="round" strokeLinejoin="round"/></svg></span>
        <h4>Profit over vanity</h4>
        <p>Every decision is judged against ROAS and real revenue — not clicks, impressions or awards.</p>
        <div className="cf-ic-stat"><b>4.08×</b><span>average return on ad spend</span></div>
      </article>
      <article className="cf-ic">
        <span className="cf-ic-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg></span>
        <h4>Radical transparency</h4>
        <p>Clear reporting, a direct line to the team, and no jargon. You always know where your money goes.</p>
        <div className="cf-ic-stat"><b>24h</b><span>average reply time</span></div>
      </article>
      <article className="cf-ic">
        ...
        <p>An ex-Google team means insights and moves no outside agency can replicate. That’s your unfair advantage.</p>
        <div className="cf-ic-stat"><b>1,000+</b><span>accounts audited</span></div>
      </article>
    </div>
  </div>
</section>
...
{/* ============ TEAM ============ */}
<section className="sec sec-cream sec-w rvsec" id="team">
  <div className="ctr">
    <div className="shead">
    ...
    <div className="team-grid rv">
      ...
      <div className="team-card">
        ...
        <span className="team-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3h8l10 10-8 8L3 11V3z" strokeLinejoin="round"/><circle cx="7.5" cy="7.5" r="1.4"/></svg>Feed expert</span>
      </div>
      <div className="team-card">
