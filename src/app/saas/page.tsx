...
{/* ============ SERVICES (fused, tailored to SaaS) ============ */}
  ...
  <div className="ctr">
    <div className="svc-grid">
      <div className="svc-copy rv">
        ...
        <h2>Google Ads that maps spend to pipeline</h2>
        <p>Capture the buyers comparing solutions and stop paying for traffic that never converts. We structure your account around product-qualified pipeline, not vanity clicks.</p>
        <ul className="svc-list">
          ...
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Competitor &amp; category capture done right</li>
...
<section className="sec sec-cream sec-w rvsec svc" id="demo-funnels">
  <div className="ctr">
    <div className="svc-grid rev">
      <div className="svc-copy rv">
        <span className="svc-num">02 &middot; Demo &amp; trial funnels</span>
        <h2>Demo &amp; trial funnels that fill your pipeline</h2>
        <p>Funnels engineered around signups and demos &mdash; with tracking wired to the metrics that actually predict revenue, so you optimise for pipeline instead of raw signups.</p>
        <ul className="svc-list">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Trial and demo funnels built to convert</li>
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Lead-quality &amp; pipeline tracking wired in</li>
  ...
  <div className="ctr">
    <div className="svc-grid">
      <div className="svc-copy rv">
        ...
        <h2>Pages that turn clicks into product-qualified pipeline</h2>
        <p>Conversion-led pages that match your positioning and turn cold clicks into demos and trials &mdash; then get A/B tested relentlessly until conversion climbs.</p>
        <ul className="svc-list">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Message-matched to each campaign &amp; persona</li>
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Signup and demo flows engineered to convert</li>
  ...
  <div className="ctr">
    <div className="svc-grid rev">
      <div className="svc-copy rv">
        ...
        <h2>Product sites built to convert &amp; scale</h2>
        <p>Need more than a landing page? We build fast, conversion-led marketing sites and custom builds &mdash; the same engineering standard behind pages that turn cold traffic into trials.</p>
        <ul className="svc-list">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Custom, conversion-led marketing-site builds</li>
