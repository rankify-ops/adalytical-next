// AUTO-GENERATED from ../adalytical/web-development.html — do not hand-edit; regenerate via scripts/gen_page.py
...
<div className="csp">
  <div className="csp-hero has-fig rvsec">
    ...
    <span className="csp-eyebrow rv"><span className="chip-plus">+</span> Web Development</span>
    <h1 className="rv">Websites engineered <span className="accent">to convert.</span></h1>
    <p className="rv">Most agency sites are built to win design awards. Ours are built to make money — fast, conversion-led websites engineered to turn cold Google Ads traffic into paying customers.</p>
    <ul className="csp-ticks rv">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Engineered to convert</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Blazing-fast &amp; SEO-ready</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Fixed quote before any work</li>
      ...
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Server-side conversion tracking</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg>Built to scale as you grow</li>
    </ul>
    ...
    <div className="csp-hero-wall rv">
      <div className="swall">
...
<section className="sec sec-cream sec-w rvsec">
  <div className="ctr">
    <div className="shead">
      ...
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">Pretty doesn’t pay. <span className="dim">Performance does.</span></h2></div>
    </div>
    <div className="cf-prob rv">
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2" strokeLinecap="round" strokeLinejoin="round"/></svg></span><h4>Slow &amp; bloated</h4><p>Heavy templates and plugins drag load times down — and every second costs you conversions and ad budget.</p></div>
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0z"/><path d="M9 15l6-6M9 9l6 6" strokeLinecap="round"/></svg></span><h4>Built for portfolios</h4><p>A site that looks great in a design showcase but has no clear path to a sale is a liability, not an asset.</p></div>
      <div className="cf-pc"><span className="cf-pc-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 19V5M4 19h16M8 15V9M13 15v-4M18 15V7" strokeLinecap="round"/></svg></span><h4>Zero tracking</h4><p>If conversions aren’t tracked cleanly, your Google Ads are flying blind — and optimisation is guesswork.</p></div>
    </div>
  </div>
</section>
...
<section className="sec sec-cream sec-w rvsec">
  <div className="ctr">
    <div className="shead">
      ...
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">Fast, clean, <span className="dim">built to sell.</span></h2></div>
    </div>
    <div className="cf-feat rv">
      <article className="cf-fc"><h4>Conversion-led builds</h4><p>Every page structured around one clear action, with the funnel mapped before a single pixel is designed.</p>
        <div className="pm"><div className="pm-hd">Build spec <span className="pm-chip">CONVERSION</span></div>
          <div className="pm-row"><span className="pm-l"><b>Clear primary CTA</b><span>Every page</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
          <div className="pm-row"><span className="pm-l"><b>Mobile-first layout</b><span>Where traffic converts</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
          <div className="pm-row"><span className="pm-l"><b>SEO foundations</b><span>Baked in</span></span><span className="pm-ok"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 6 9 17l-5-5" strokeLinecap="round" strokeLinejoin="round"/></svg></span></div>
        </div>
      </article>
      <article className="cf-fc"><h4>Blazing fast</h4><p>Lean, hand-built front-ends that load in under a second — because speed is conversion, and conversion is revenue.</p>
        <div className="pm"><div className="pm-hd">Site performance <span className="pm-chip">SHIPPED</span></div>
          ...
          <div className="pm-row"><span className="pm-l"><b>Core Web Vitals</b><span>All passing</span></span><span className="pm-tag">Green</span></div>
        </div>
      </article>
      <article className="cf-fc"><h4>Tracking baked in</h4><p>Server-side conversion tracking wired from day one, so your Google Ads always know exactly what’s working.</p>
        <div className="pm"><div className="pm-hd">Conversion tracking <span className="pm-chip">LIVE</span></div>
          <div className="pm-row"><span className="pm-l"><b>Server-side tagging</b><span>GA4 + Ads</span></span><span className="pm-tag">Live</span></div>
          <div className="pm-row"><span className="pm-l"><b>Events mapped</b><span>Full funnel</span></span><span className="pm-val">12</span></div>
          <div className="pm-row"><span className="pm-l"><b>Attribution</b><span>Click to sale</span></span><span className="pm-val up">100%</span></div>
        </div>
      </article>
    </div>
  </div>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      <span className="shead-chip rv"><span className="chip-plus">+</span> Platforms we build on</span>
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">The right stack <span className="dim">for the job.</span></h2></div>
    </div>
    <div className="cf-verts rv">
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M6 6h15l-1.5 9h-12z" strokeLinejoin="round"/><circle cx="9" cy="20" r="1.4"/><circle cx="18" cy="20" r="1.4"/></svg><span>Shopify</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="4" width="18" height="14" rx="2"/><path d="M3 9h18" strokeLinecap="round"/></svg><span>WordPress</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 7l8-4 8 4-8 4z" strokeLinejoin="round"/><path d="M4 7v10l8 4 8-4V7" strokeLinejoin="round"/></svg><span>Webflow</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 8l-4 4 4 4M15 8l4 4-4 4" strokeLinecap="round" strokeLinejoin="round"/></svg><span>Custom / Headless</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="9"/><path d="M12 3v18M3 12h18" strokeLinecap="round"/></svg><span>Next.js &amp; React</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M6 6h15l-1.5 9h-12z" strokeLinejoin="round"/><path d="M6 6 5 3H2" strokeLinecap="round"/></svg><span>WooCommerce</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M4 8h16M8 13h8M8 17h5" strokeLinecap="round"/></svg><span>Landing pages</span></span>
      <span className="cf-vert"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 19V5M4 19h16M8 15V9M13 15v-4M18 15V7" strokeLinecap="round"/></svg><span>Conversion tracking</span></span>
    </div>
  </div>
</section>
...
<section className="sec sec-cream rvsec">
  <div className="ctr">
    <div className="shead">
      ...
      <div className="shead-main"><span className="shead-brand rv">Adalytical®</span><h2 className="shead-t rv">A rebuild that <span className="dim">paid for itself.</span></h2></div>
    </div>
    <div className="cf-case rv">
      ...
      <div className="cf-case-body">
        <span className="cf-case-tag">Website rebuild · Home services</span>
        <h3>A faster site that turned more clicks into calls.</h3>
        <p>We rebuilt a slow, dated website into a fast, conversion-led site with clean tracking — so every Google Ads dollar could finally be measured, and optimised, against real bookings.</p>
        <div className="cf-case-stats">
          <div className="cf-case-stat"><b>98</b><span>pagespeed score</span></div>
          <div className="cf-case-stat"><b>−26%</b><span>bounce rate</span></div>
          <div className="cf-case-stat"><b>+40%</b><span>enquiries from ads</span></div>
        </div>
      </div>
    </div>
  </div>
...
<section className="sec sec-cream sec-w cta rvsec" id="book">
  <div className="ctr"><div className="cta-card rv">
    ...
    <h2>Is your website costing you conversions?</h2>
    <p>Book a free site audit and we’ll show you exactly where your site is losing customers — and what we’d rebuild to fix it. No pitch, no pressure.</p>
